...
const Hero2 = () => {
  return (
    ...
    >
      {/* Layer 1: Background Image (h2.png) */}
      <div className="absolute inset-0" style={{ zIndex: 1 }}>
        <Image
          src="/images/h2.png"
          alt="Mount Abu Background 2"
          fill
      ...
      {/* Majestic Text - Positioned independently on the left (same as Hero) */}
      <span
      ...
      {/* Layer 2: Main Title Text - Between background and foreground (same position as Hero) */}
      <div
      ...
      {/* Layer 3: Foreground Image (h2-2.png) - Mountain/landscape overlay (same as Hero) */}
      <div
